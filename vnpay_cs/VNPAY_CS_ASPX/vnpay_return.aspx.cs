    ...
    public partial class vnpay_return : System.Web.UI.Page
    {
        ...
        protected async void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString.Count > 0)
            {
                ...
                string adId = Request.Cookies["adId"]?.Value;
                ...
                if (checkSignature)
                {
                    if (vnp_ResponseCode == "00" && vnp_TransactionStatus == "00")
                    {
                        ...
                        string apiUrl = $"https://localhost:7248/api/AdertisementOrder/UpdateIsPending/isPending/{adId}";
                        ...
                        try
                        {
                            using (HttpClient client = new HttpClient())
                            {
                                ...
                                if (response.IsSuccessStatusCode)
                                {
                                    ...
                                    Console.WriteLine("API đã được gọi thành công.");
                                }
                                else
                                {
                        ...
                        string redirectUrl = "http://localhost:3000/Ok?amount=" + vnp_Amount.ToString();
